...
export function ContactPage({ onPageChange }: ContactPageProps) {
  ...
  const generateMailtoUrl = (data: typeof formData) => {
    const recipient = "info@thonbridge.com";
...
${data.company}
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        toast.success(
          "Opening your mail app with pre-filled inquiry. Please review and send the email to complete your submission."
        );
      ...
      toast.error(
        "Failed to open mail app. Please try again or contact us directly at info@thonbridge.com"
      );
  ...
  const contactMethods = [
      ...
      icon: (
          ...
          >
            <path
              ...
              strokeWidth={2}
              d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h1m0 0h8"
            />
          </svg>
      ),
      details: [
    ...
    },
    {
      ...
      details: ["Canada: +1 403 988 2116", "Nigeria: +234 703 2168 996"],
    },
  ];
  ...
  return (
    <div className="bg-white">
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #001a3d 0%, #002d5f 25%, #003883 50%, #0047a0 75%, #0056bd 100%)",
        }}
      >
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(0, 26, 61, 0.8) 0%, rgba(0, 45, 95, 0.7) 25%, rgba(0, 56, 131, 0.6) 50%, rgba(0, 71, 160, 0.7) 75%, rgba(0, 86, 189, 0.8) 100%)",
            }}
          ></div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <div
                ...
                className={`inline-block px-3 py-1.5 sm:px-4 sm:py-2 md:px-6 md:py-3 bg-[#003883] text-white text-[9px] sm:text-[10px] md:text-[12px] uppercase tracking-[1.5px] sm:tracking-[2px] md:tracking-[3px] mb-4 sm:mb-6 md:mb-8 fade-in-scale ${
                  badgeAnimation.isVisible ? "visible" : ""
                }`}
              >
                <span
                  style={{
              ...
              <h1
                ...
                className={`text-white mb-4 sm:mb-6 md:mb-8 uppercase fade-in-left ${
              ...
              <div
                ...
                className={`space-y-3 sm:space-y-4 md:space-y-6 text-white mb-6 sm:mb-8 md:mb-10 hero-subtitle fade-in-right ${
              ...
              >
                <p>
                  Connect with THONBRIDGE's global network of experts. Whether
                  you're looking to streamline procurement, expand international
                  trade, or implement cutting-edge engineering solutions, our
                  team is ready to deliver results.
                </p>
                <p className="hidden sm:block">
                  With offices spanning multiple continents and partnerships
                  across 25+ countries, we're positioned to support your
                  business ambitions wherever they may lead.
                </p>
              </div>
              ...
              <div
                ...
                className={`grid grid-cols-3 gap-3 sm:gap-4 md:gap-8 fade-in-up ${
              ...
              >
                {[
                  ...
                  <div
                    key={index}
                    className={`text-center fade-in-scale stagger-${
                      index + 1
                    } ${statsAnimation.isVisible ? "visible" : ""}`}
                  >
                    <div
                      className="text-white mb-1 sm:mb-2 text-sm sm:text-lg md:text-2xl"
                      style={{
                        fontFamily: "ITC Avant Garde Gothic Std Bold",
                        fontWeight: 900,
                      }}
                    ...
                    <div
                      className="text-white uppercase text-[7px] sm:text-[8px] md:text-[10px] tracking-[1px]"
                      style={{
                        fontFamily: "ITC Avant Garde Gothic Std Bold",
                        fontWeight: 400,
                      }}
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="container-1920">
          <div
            ...
            className={`text-center mb-8 sm:mb-12 lg:mb-16 fade-in-up ${
              contactHeaderAnimation.isVisible ? "visible" : ""
            }`}
          >
            ...
            <h2
              className="text-[#2B2B2B] mb-4 sm:mb-6 md:mb-8 uppercase text-xl sm:text-2xl md:text-3xl lg:text-4xl"
              style={{
                fontFamily: "ITC Avant Garde Gothic Std Bold",
                fontWeight: 900,
              }}
          ...
          <div
            ...
            className={`grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12 lg:mb-16 fade-in-up ${
          ...
          >
            {contactMethods.map((method, index) => (
              <div
                ...
                className={`bg-white p-4 sm:p-6 md:p-8 border border-[#e5e5e5] hover:border-[#003883] transition-colors duration-300 group fade-in-scale stagger-${
                  index + 1
                } ${contactMethodAnimations[index].isVisible ? "visible" : ""}`}
              >
                ...
                <h3
                  className="text-[#2B2B2B] mb-3 sm:mb-4 md:mb-6 uppercase tracking-[1px] text-xs sm:text-sm md:text-base"
                  style={{
                    fontFamily: "ITC Avant Garde Gothic Std Bold",
                    fontWeight: 900,
                  }}
                ...
                <div className="space-y-1.5 sm:space-y-2 md:space-y-3">
                  {method.details.map((detail, i) => (
                    <div
                      key={i}
                      className="text-[#515960] text-xs sm:text-sm"
                      style={{
                        fontFamily: "ITC Avant Garde Gothic Std Bold",
                        fontWeight: 400,
                        lineHeight: "1.4",
                    ...
                    >
                      {detail === "info@thonbridge.com" ? (
                        <a
                          href="mailto:info@thonbridge.com"
                          className="text-[#003883] hover:text-[#002d6b] transition-colors duration-200 cursor-pointer"
                          style={{
                            fontFamily: "ITC Avant Garde Gothic Std Bold",
                            fontWeight: 400,
                            lineHeight: "1.4",
        ...
        <div className="container-1920">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-16">
            ...
            >
              ...
              <div
                className="text-[#515960] mb-6 sm:mb-8 md:mb-10 text-xs sm:text-sm md:text-base"
                style={{
                  fontFamily: "ITC Avant Garde Gothic Std Bold",
                  fontWeight: 400,
                  lineHeight: "1.5",
              ...
              >
                Complete the form below and our team will respond within 4 hours
                during business hours. For urgent matters, please call our
                emergency line.
              </div>
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-[#2B2B2B] mb-1.5 sm:mb-2 md:mb-3 uppercase tracking-[1px] text-[10px] sm:text-xs"
                      style={{
                        fontFamily: "ITC Avant Garde Gothic Std Bold",
                        fontWeight: 900,
                      }}
                ...
                >
                  {isSubmitting ? (
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <span
                        className="uppercase tracking-[1px] sm:tracking-[2px] text-[10px] sm:text-[11px] md:text-[12px]"
                        style={{
                          fontFamily: "ITC Avant Garde Gothic Std Bold",
                          fontWeight: 500,
                        }}
              ...
              <div className="relative h-[250px] sm:h-[300px] md:h-[400px] mb-4 sm:mb-6 md:mb-8">
                ...
                <div className="absolute bottom-3 sm:bottom-4 md:bottom-6 left-3 sm:left-4 md:left-6 right-3 sm:right-4 md:right-6">
                  <div className="bg-[#2B2B2B] bg-opacity-95 p-3 sm:p-4 md:p-6">
                    <h3
                      className="text-white mb-2 sm:mb-3 md:mb-4 uppercase tracking-[1px] text-[10px] sm:text-xs md:text-sm"
                      style={{
                        fontFamily: "ITC Avant Garde Gothic Std Bold",
                        fontWeight: 900,
                      }}
                    ...
                    <div className="grid grid-cols-3 gap-1.5 sm:gap-2 md:gap-4">
                      {[
                        ...
                        <div key={index} className="text-center">
                          <div
                            className="text-[#003883] mb-0.25 sm:mb-0.5 md:mb-1 text-xs sm:text-sm md:text-base"
                            style={{
                              fontFamily: "ITC Avant Garde Gothic Std Bold",
                              fontWeight: 900,
                            }}
                          ...
                          <div
                            className="text-white uppercase text-[6px] sm:text-[7px] md:text-[8px] tracking-[1px]"
                            style={{
                              fontFamily: "ITC Avant Garde Gothic Std Bold",
                              fontWeight: 400,
                            }}
                  ...
                  {[
                    {
                      ...
                      desc: "Comprehensive project assessment and requirement analysis",
                    },
                    {
                      step: "02",
                      title: "Proposal Development",
                      desc: "Detailed solution design with timeline and budget",
                    },
                    {
                      step: "03",
                      title: "Contract & Execution",
                      desc: "Project implementation with dedicated account management",
                    },
                    {
                      step: "04",
                      title: "Delivery & Support",
                      desc: "Final delivery with ongoing support and optimization",
                    },
                  ].map((process, index) => (
                    <div key={index} className="flex gap-2 sm:gap-3 md:gap-4">
                      <div
                        className="text-[#003883] min-w-[25px] sm:min-w-[30px] md:min-w-[40px] text-[10px] sm:text-xs md:text-sm"
                        style={{
                          fontFamily: "ITC Avant Garde Gothic Std Bold",
                          fontWeight: 900,
                        }}
                      ...
                      <div>
                        <div
                          className="text-[#2B2B2B] mb-0.5 sm:mb-1 uppercase text-[9px] sm:text-[10px] md:text-xs tracking-[1px]"
                          style={{
                            fontFamily: "ITC Avant Garde Gothic Std Bold",
                            fontWeight: 900,
                          }}
                        ...
                        <div
                          className="text-[#515960] text-[9px] sm:text-[10px] md:text-xs"
                          style={{
                            fontFamily: "ITC Avant Garde Gothic Std Bold",
                            fontWeight: 400,
                            lineHeight: "1.4",
